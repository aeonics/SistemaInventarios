...
//////////// SE ACTUALIZA SIEMPRE Y CUANDO NO HAYA ERRORES
  ...
  if ($error == "") {
    $query="UPDATE Equipo_Computo SET Marca = '$marca', Modelo='$modelo', Serie= '$serie', Descripcion = '$descripcion', NoParte= '$parte', Costo ='$costo', RutaImagen='$nombre_img', FActura='$pdf', XML='$xml_name', Iva='$iva', FechaCompra = '$fechacompra', ValorActual= '$valoractual', Ubicacion_idUbicacion = '$ubicacion', Empleado_idEmpelado = '$responsable', Proveedores_idProveedores = '$proveedor', Estatus= '$estatus', Antiguedad ='$calc_edad' WHERE id_sistema ='$id_ec'";
