...
<link rel="stylesheet" href="css/base.css" charset="utf-8">
	...
	<body>
		...
		<div id="CONTENIDO">
							<span id="contenido1">
								<a href="mod_equipo_edificios.php" title="Da clic sobre la imagen para continuar"><img src="imagen/iconos/edificios.jpg" width="350px"/></a>
								<h2>MODULO DE INVENTARIO DE EDIFICIOS</h2>
									<br><hr>
								<p>
