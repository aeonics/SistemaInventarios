		...
		<div id="CONTENIDO">
			...
			<div><br><br><br>
								...
								<form class="formulario_general" action="" method="POST">
										<ul>
										<fieldset>
												<legend>Coloca el ID del Proveedor a editar</legend>
												 <li>
														<input class="campo-estilo full-field align-left" type="number" name="id" placeholder="ID para editar" title="Coloca el ID que quieres editar" maxlength="10" pattern="[0-9]{1-10}" required  >
...
<br>
				<form class="formulario_general" action="guardar_proveedores.php" method="POST">
		...
		<li>
			<textarea class="campo-estilo full-field" name="bancarios" rows="8" cols="30" maxlength="60"><?php echo $rows['DatosBancarios']; ?></textarea>
				...
				<br>
					...
					<ul>
						<input  id="boton_enviar" type="submit" name="guardar" value="Actualizar">
				</form>
				<?php if(!empty($error)): ?>
					<div class="error">
						<ul>
